...
import { GitHubProps, DefaultButtonProps } from "@/schema/buttons.schema";
...
*/
export function GitHubButton({ message, stars }: GitHubProps) {
    return (
        <button className="border border-black inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-4 py-2 group bg-gray-900 hover:bg-gray-950 transition-all duration-200 ease-in-out hover:ring-2 hover:ring-offset-2 hover:ring-gray-900">
...
export function AIButton({ message }: DefaultButtonProps) {
    return (
    <button className="bg-white text-center w-48 rounded-2xl h-14 relative text-black text-xl font-semibold group cursor-pointer" type="button">
